____________________________ Portuguese Version ____________________________
...
____________________________ English Version _______________________________

# Association Rules and Repurchase Prediction for Online Supermarket with Market Basket Analysis and Machine Learning

Whether you shop with meticulously planned shopping lists or let whim guide your steps, our unique shopping rituals define who we are. Instacart, a grocery ordering and delivery app, aims to make filling your fridge and pantry with your favorite personal items and essentials as easy as possible. After selecting products through the Instacart app, shoppers review their orders, make purchases, and have them delivered to the nearest store to you.

The Instacart Data Science Team plays a crucial role in providing this enjoyable shopping experience. Currently, they use transactional data to develop models that predict which products a user will purchase again, which they will try for the first time, or which they will add to their cart during a session. Recently, Instacart made this data available openly, and the download link can be found below.

In this Data Science project, you will use this anonymous data on customer orders over time to predict which previously purchased products will be in a user's next order.

We will use the R language and the Market Basket Analysis packages offered by the language. The dataset download link is:
[https://www.kaggle.com/competitions/instacart-market-basket-analysis]